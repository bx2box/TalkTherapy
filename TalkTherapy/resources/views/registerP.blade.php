...
<body>
    <form action="{{ route('registerP') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div>
        ...
        <div>
            <label for="num_colegiado">Numero de colegiado</label>
            <input type="text" name="num_colegiado" id="num_colegiado" required>
        </div>
        <div>
            <label for="precio_sesion">Tarifa esperada por sesión</label>
            <input type="text" name="precio_sesion" id="precio_sesion" required>
        </div>
        <div>
        ...
        <div>
            <label for="foto_diploma">Foto del diploma de psicologo</label>
            <input type="file" name="foto_diploma" id="foto_diploma" accept="image/*" required>
        </div>
